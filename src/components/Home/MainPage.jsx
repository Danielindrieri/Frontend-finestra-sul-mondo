...
const MainPage = () => {
  ...
  return (
    <div className="container-fluid adjust p-0 m-0">
      ...
      <div
        className="row background-style"
        style={{
          ...
          <Card className="gradiente">
            <Card.Body>
              <blockquote className="blockquote mb-0">
                ...
                />
                <p>
                  Finestra sul Mondo è il tuo portale dedicato ai viaggi, un
                  luogo dove ogni itinerario inizia guardando il mondo da un
                  finestrino: che tu sia su un aereo, una nave, un treno o in
                  auto, la tua prossima avventura è a portata di clic!
                </p>
              </blockquote>
            </Card.Body>
          </Card>
          ...
          <Card className="gradiente">
            <Card.Body>
              <blockquote className="blockquote mb-0">
                ...
                />
                <p>
                  Finestra sul Mondo è il tuo biglietto per esplorare il mondo.
                  Dalle montagne ai mari, dai borghi incantati alle grandi
                  metropoli, ogni viaggio è un'occasione per scoprire nuove
                  prospettive. Parti ora, la tua prossima destinazione ti
                  aspetta!
                </p>
              </blockquote>
            </Card.Body>
        ...
        <div className="col-6 mb-4 space z-2">
          <div
            id="customCarousel2"
            className="carousel slide "
            data-bs-ride="carousel"
