    ...
    <footer className="back text-dark">
      <div className="container py-4">
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            ...
            <p className="text-muted">
              Il tuo portale dedicato ai viaggi. Scopri itinerari unici e pianifica la tua prossima avventura!
            </p>
          </div>
          ...
          <div className="col-md-4 mb-4">
            ...
            <ul className="list-unstyled ">
              <li><a href="/itinerari" className="text-dark text-decoration-none">Itinerari</a></li>
        ...
        <div className="text-center pt-3 border-top border-dark">
          <p className="text-muted mb-0">&copy; {new Date().getFullYear()} Finestra sul Mondo. Tutti i diritti riservati.</p>
        </div>
      </div>
    </footer>
  );
